...
/**
 * Settings form UI for the Code Pointer plugin. Provides a user-friendly interface for configuring
 * plugin settings.
 */
class CodePointerSettingsForm {
  ...
  private fun setupComponents() {
    ...
    // Add tooltips
    pathReferenceModeComboBox.toolTipText =
        "Choose how file paths are referenced in copied code pointers"
    includeColumnNumbersCheckBox.toolTipText =
        "Include column numbers for more precise references (e.g., file.java:5:10)"
  ...
  fun getPathReferenceMode(): PathReferenceMode =
      pathReferenceModeComboBox.selectedItem as PathReferenceMode
